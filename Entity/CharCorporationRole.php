...
/**
 * @ORM\Entity
 * @ORM\Table(name="charCorporationRole")
 */
class CharCorporationRole
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CharCharacterSheet", inversedBy="corporationRoles")
