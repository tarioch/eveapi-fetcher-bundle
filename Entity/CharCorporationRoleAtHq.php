...
/**
 * @ORM\Entity
 * @ORM\Table(name="charCorporationRoleAtHq")
 */
class CharCorporationRoleAtHq
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CharCharacterSheet", inversedBy="corporationRolesAtHq")
     ...
     * @return CharCorporationRoleAtHq
     */
